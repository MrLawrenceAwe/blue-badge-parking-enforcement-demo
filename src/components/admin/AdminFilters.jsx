...
export function AdminFilters({ filterForm, filtersOpen, resultCount, setFiltersOpen }) {
  ...
  return (
    <details
      className="filter-toolbar admin-filters"
    ...
    >
      <summary>
        ...
        <span className="filter-result-count">{resultCount} shown</span>
      </summary>
      ...
      <div className="filter-toolbar-fields">
        <label>
          ...
          <input
            ...
            onChange={(event) => filterForm.setValues({ ...filterForm.values, search: event.target.value })}
            placeholder="Badge, vehicle registration, holder, location, date, priority"
          />
        </label>
        <label>
          Review priority
        ...
        <label>
          ...
          <input
            ...
            onChange={(event) => filterForm.setValues({ ...filterForm.values, location: event.target.value })}
            placeholder="Town, street, zone"
          />
        </label>
        <label>
          Date
          <input
            ...
            onChange={(event) => filterForm.setValues({ ...filterForm.values, date: event.target.value })}
          />
        </label>
        <label>
          Badge status
          <select
            value={filterForm.values.badgeStatus}
            onChange={(event) => filterForm.setValues({ ...filterForm.values, badgeStatus: event.target.value })}
          >
            <option value="all">All</option>
