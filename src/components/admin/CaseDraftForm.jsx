...
export function CaseDraftForm({
  ...
  return (
    <>
      ...
      <textarea value={newCaseDraft.note} onChange={(event) => updateNewCaseDraft('note', event.target.value)} aria-label="Case note" placeholder="Add officer note, evidence reference, or review outcome" />
